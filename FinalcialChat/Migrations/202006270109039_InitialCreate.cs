    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.ApplicationUser_Id, t.Chatroom_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Messages", "CreatedBy", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.ApplicationUserChatrooms", "Chatroom_Id", "dbo.Chatrooms");
            DropForeignKey("dbo.ApplicationUserChatrooms", "ApplicationUser_Id", "dbo.AspNetUsers");
            DropIndex("dbo.ApplicationUserChatrooms", new[] { "Chatroom_Id" });
